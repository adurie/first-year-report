...
\begin{equation}
	\int_{-\infty}^{+\infty} e^{(\frac{i}{2}{\bf x^TAx})}d^n{\bf x}=\sqrt{\frac{(2\pi i)^n}{{\rm det}A}}
\end{equation}
...
\begin{equation}
	\frac{2\pi i}{\sqrt{{\rm n}^2{\rm det}(\partial^2\phi_s)}} = \frac{2\pi\tau}{{\rm n}|{\rm det}(\partial^2\phi_s)|^{\frac{1}{2}}}
\end{equation}
