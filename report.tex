...
The representation in $k$-space is thus
	...
	\begin{flalign}
		{\bf u}_{ii} &= \frac{\langle{\bf k}_\parallel, n_3, {\bf s}_i|{\bf H}|\acute{\bf k}_\parallel, n_3, {\bf s}_i\rangle}{\delta_{\bf k_\parallel\acute{k_\parallel}}}\nonumber\\&=
\sum_{{\bf d}\in N_\parallel}e^{i\bf k_\parallel \cdot d}\langle{\bf 0}, 0, {\bf 0}|{\bf H}|{\bf d}, 0, {\bf 0}\rangle\nonumber\\&=
	...
	\begin{flalign}
		{\bf u}_{12} &= \frac{\langle{\bf k}_\parallel, n_3, {\bf s}_1|{\bf H}|\acute{\bf k}_\parallel, n_3, {\bf s}_2\rangle}{\delta_{\bf k_\parallel\acute{k_\parallel}}}\nonumber\\&=
