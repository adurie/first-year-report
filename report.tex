...
\subsubsection{1-band Simple Cubic model}
	...
	\begin{equation}\label{dispersion}
		\varepsilon = {\rm u + 2t}\left(\cos({\bf k}_\parallel a)+\cos(k_\perp a)\right)	
	\end{equation}
	...
	Since
	\begin{equation}
		k_\perp \rm= \frac{1}{\mathnormal a}\cos^{-1}\Big(\frac{\varepsilon - u}{2t} - \cos(\bf k_\parallel \mathnormal a)\Big)
	\end{equation}
	Then
	\begin{equation}
		\frac{\partial k_\perp}{\partial\bf k_\parallel} = -\frac{\sin({\bf k}_\parallel a)}{\sqrt{-\left(\frac{\varepsilon -{\rm u}}{2{\rm t}}-\cos({\bf k}_\parallel a)\right)^2 -1}}
	\end{equation}
