...
\begin{equation}\label{subs}
	\int_{-\infty}^{+\infty}d^2 {\bf k}_\parallel \mathnormal e^{i(\frac{\rm n}{2}({\bf k}_\parallel - {\bf k}_\parallel^0)^T(\partial^2\phi_s) ({\bf k}_\parallel - {\bf k}_\parallel^0))} \equiv\int_{-\infty}^{+\infty}d^2 {\bf y} \mathnormal e^{(\frac{i}{2}{\bf y}^T( {\rm n}\partial^2\phi_s) {\bf y})}
\end{equation}
...
\begin{equation}
\frac{2\pi\tau}{{\rm n}|{\rm det}(\partial^2\phi_s)|^{\frac{1}{2}}}
\end{equation}
